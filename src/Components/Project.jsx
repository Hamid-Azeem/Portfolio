...
const Projects = () => {
    ...
    return (
        <>
            <section id='projects' className="projects-section py-16 px-8 mt-1rem bg-white text-gray-900">
                <div className="container mx-auto px-4">
                    <h1 className="text-4xl md:text-5xl text-center text-[#353535] font-bold pb-5 mb-8">Projects</h1>
                    
                    {/* Carousel for smaller screens */}
                    <div className="block md:hidden">
                        <Carousel showThumbs={false} showStatus={true} showArrows={false} showIndicators={false}>
